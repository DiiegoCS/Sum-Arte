...
env = environ.Env()
# leer explícitamente el .env dentro del paquete `core` (core/.env)
...
# usar env.bool para castear a booleano correctamente
...
if not DEBUG:
    # usar default para evitar ImproperlyConfigured si no está definida
